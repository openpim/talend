...
@Icon(value = CUSTOM, custom = "PIMSelect") // icon is located at src/main/resources/icons/PIMInput.svg
@PartitionMapper(name = "Select")
@Documentation("TODO fill the documentation for this mapper")
public class PIMSelectMapper implements Serializable {
    private final PIMSelectMapperConfiguration configuration;
    private final PimComponentsService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public PIMSelectMapper(@Option("configuration") final PIMSelectMapperConfiguration configuration,
    ...
    @Split
    public List<PIMSelectMapper> split(@PartitionSize final long bundles) {
    ...
    @Emitter
    public PIMSelectSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new PIMSelectSource(configuration, recordBuilderFactory);
    }
}